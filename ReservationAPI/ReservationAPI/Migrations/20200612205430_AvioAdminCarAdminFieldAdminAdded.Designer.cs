...
namespace ReservationAPI.Migrations
{
    ...
    [Migration("20200612205430_AvioAdminCarAdminFieldAdminAdded")]
    partial class AvioAdminCarAdminFieldAdminAdded
    {
            ...
            modelBuilder.Entity("ReservationAPI.Models.Airlines.Flight", b =>
                {
                    ...
                    b.Property<long?>("EndingDestinationId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("StartingDestinationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ReservationAPI.Models.Airlines.Flight", b =>
                {
                    ...
                    b.HasOne("ReservationAPI.Models.Airlines.Destination", "EndingDestination")
                        .WithMany()
                    ...
                    b.HasOne("ReservationAPI.Models.Airlines.Destination", "StartingDestination")
                        .WithMany()
