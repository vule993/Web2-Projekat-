...
namespace ReservationAPI.Migrations
{
    ...
    [Migration("20210908065413_UserFriend")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservationAPI.Entities.UserFriend", b =>
                {
            ...
            modelBuilder.Entity("ReservationAPI.Entities.UserFriend", b =>
                {
                    b.HasOne("ReservationAPI.Models.User", "DestinationUser")
                        .WithMany()
                        .HasForeignKey("DestinationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReservationAPI.Models.User", "SourceUser")
                        .WithMany()
